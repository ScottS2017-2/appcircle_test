...
class AppColors {
  ...
  // Custom Colors
  static const Color loginAndSignupBoxes = Color(0x55768fff);
  static const Color loginAndSignupBoxesBorder = Color(0x77000000);
  static const Color customDropShadowColor = Color(0x99000000);
